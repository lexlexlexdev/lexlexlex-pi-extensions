...
const SCHEMA_URL =
  'https://raw.githubusercontent.com/CarterMcAlister/pi-packages/main/packages/pi-multicodex/schemas/codex-accounts.schema.json'
...
const AccountSchema = z
  .object({
    ...
    alias: z
      ...
      .min(1)
      .optional()
      .meta({ description: 'Optional display alias' }),
    accessToken: z
      .string()
      .min(1)
...
export function getAccountLabel(
  account: Pick<Account, 'email' | 'alias'>,
): string {
  return account.alias?.trim() || account.email
}
